...
namespace ExplorationEngine.GUI
{
	public class NewGame : GUIPage
	{
		...
		public NewGame() : base()
		{
			...
			//Main form
			Form_Main = new dForm("NewGame", new Rectangle(0, 0, (int)Engine.CurrentScreenResolution.X, (int)Engine.CurrentScreenResolution.Y), Engine.StarField, null, false, false);
